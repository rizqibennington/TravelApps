...
import com.rizqi.travel.adapter.HistoryKeretaAdapter;
...
public class HistoryKeretaActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        final ArrayList<HistoryKeretaModel> hasil = new ArrayList<>();
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". " +
                    "Jumlah pembelian tiket dewasa = " + dewasa + " dan tiket anak = " + anak + ".";
            hasil.add(new HistoryKeretaModel(id_book, tanggal, riwayat, total, R.drawable.profile));
        }

        ListView listBook = findViewById(R.id.list_booking);
        HistoryKeretaAdapter arrayAdapter = new HistoryKeretaAdapter(this, hasil);
        ...
        listBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(HistoryKeretaActivity.this);
